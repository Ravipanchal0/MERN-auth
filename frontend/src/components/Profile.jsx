...
import { logout as authLogout, updateProfile } from "../slices/authSlice.js";
...
const Profile = () => {
  ...
  const [profileUpdate, { isLoading: profileUpdateLoader }] =
    useProfileUpdateMutation();
  const [changePassword, { isLoading: changePasswordLoader }] =
    useChangePasswordMutation();
